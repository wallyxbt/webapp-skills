...
- UI + wallet + hooks: [solana-frontend.md](solana-frontend.md)
- Kit ↔ web3.js boundary: [solana-kit-web3-interop.md](solana-kit-web3-interop.md)
- Anchor programs: [solana-anchor.md](solana-anchor.md)
- Pinocchio programs: [solana-pinocchio.md](solana-pinocchio.md)
- Testing strategy: [solana-testing.md](solana-testing.md)
- IDLs + codegen: [solana-idl-codegen.md](solana-idl-codegen.md)
- Payments: [solana-payments.md](solana-payments.md)
- Security checklist: [solana-security.md](solana-security.md)
- Reference links: [solana-resources.md](solana-resources.md)
